  ...
  return (
    <div id="content">
      ...
      <ul className="timeline">
        ...
        <li className="event" data-date="9:30am - 10:30am">
          <h3>Total tone</h3>
          <p>
        ...
        <li className="event" data-date="10:30am - 11:30am">
          <h3>Zumba</h3>
          <p>
            A vigorous dance className to Latin music. Helps tone, shape and
            condition your body, burning up to 800 calories in one hour
            depending on how much you put in.
          </p>
        </li>
        <li className="event" data-date="12:30pm - 1:30pm">
          <h3>Active Me</h3>
          <p>
        ...
        <li className="event" data-date="5:30pm - 6:30pm">
          <h3>Zumba</h3>
          <p>
            A vigorous dance className to Latin music. Helps tone, shape and
            condition your body, burning up to 800 calories in one hour
        ...
        <li className="event" data-date="6:00pm - 6:45pm">
          <h3>Spinning</h3>
          <p>
            A vigorous className using stationary bikes with weighted flywheel.
            Focuses on strength, endurance, intervals and recovery. Burns
            calories and shapes muscles. Instructor led.
          </p>
        </li>
        <li className="event" data-date="6:30pm - 7:30pm">
          <h3>Pilates</h3>
          <p>
        ...
        <li className="event" data-date="7:00pm - 7:45pm">
          <h3>Spinning</h3>
          <p>
            A vigorous className using stationary bikes with weighted flywheel.
            Focuses on strength, endurance, intervals and recovery. Burns
        ...
        <li className="event" data-date="7:00pm - 8:00pm">
          ...
          <p>
            ...
            className that is kind to joints and good fun too. Instructor led.
          </p>
        </li>
        <li className="event" data-date="7:30pm - 8:30pm">
          <h3>Total tone</h3>
          <p>
            Focuses on strength and endurance for the whole body and improves
            muscle tone. Instructor led.
        ...
        <li className="event" data-date="8:00pm - 9:00pm">
          <h3>Aqua Running</h3>
          <p>
            Aqua Running is a water className which uses all the major muscle
            groups. It results in total body conditioning and burns calories
            faster than any known activity.
          </p>
        </li>
        <li className="event" data-date="8:30pm - 9:00pm">
          <h3>Metafit</h3>
